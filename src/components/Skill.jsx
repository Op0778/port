...
const skills = [
  ...
  { skill: "JavaScript", percent: 75, icon: <FaJs size={80} color="#F7DF1E" /> },
  { skill: "React", percent: 70, icon: <FaReact size={80} color="#61DAFB" /> },
  { skill: "MongoDB", percent: 50, icon: <SiMongodb size={80} color="#47A248" /> },
  { skill: "PHP", percent: 40, icon: <FaPhp size={80} color="#777BB4" /> },
  { skill: "SQL", percent: 40, icon: <SiMysql size={80} color="#00618A" /> },
  { skill: "Python", percent: 80, icon: <FaPython size={80} color="#3776AB" /> },
  { skill: "C/C++", percent: 80, icon: <SiCplusplus size={80} color="#00599C" /> },
];
